# flow_3_Utilizaciondashboard-text
...
El flow 3 muestra el uso de los nodos dashboard (en especifico el nodo "text")
Un nodo de texto presenta la información del timestamp convertido a un string de fecha del flow 2.
...
1. Duplicar el flow 2 con las mecanicas de exportar e importar (revise el boton hamburguesa)
2. Renombrar el flow a Flow 3
3. Agregar el nodo texto (text)
